...
public class C05_ArrayOlustur {
    ...
    public static int[] arrayOlustur(){
        ...
        System.out.println("Lütfen oluşturmak istediğiniz Array'in uzunluğunu giriniz");
        int uzunluk = scanner.nextInt();
        int[] arr = new int[uzunluk]; // [0,0,0,0,0,0.......]
        for (int i = 0; i < arr.length; i++) {
            scanner = new Scanner(System.in); // for loop la her seferinde değer alabilmek için
